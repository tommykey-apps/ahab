const dict = {
  ja: {
    ...
    "confirm.deleteContainer.title": "コンテナを削除",
    "confirm.deleteContainer.body": "{name} を削除します。実行中の場合は、続けて強制削除の確認を表示します。",
    ...
    "confirm.volumeInUse.title": "ボリュームは使用中です",
    "confirm.volumeInUse.body": "{name} は {containers} が使用しています。先にコンテナタブでそのコンテナを削除してください。",
    "confirm.volumeInUse.bodyUnknown": "{name} はコンテナが使用しています。先にコンテナタブでそのコンテナを削除してください。",
  ...
  en: {
    ...
    "confirm.deleteContainer.title": "Delete container",
    "confirm.deleteContainer.body": "Delete {name}. If it is running, you will be asked to force delete it next.",
    ...
    "confirm.volumeInUse.title": "Volume is in use",
    "confirm.volumeInUse.body": "{name} is used by {containers}. Delete those containers on the Containers tab first.",
    "confirm.volumeInUse.bodyUnknown": "{name} is used by a container. Delete that container on the Containers tab first.",
